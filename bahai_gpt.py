...
generate_content_config = types.GenerateContentConfig(
        ...
        system_instruction=[
            types.Part.from_text(text="""Answer questions from a Baha'i perspective, 
                                 ...
                                 If you're not able to find the information on these sites then try to find the information on 
                                 other sites. Explicitly reference the name of the website (not the link) where you get information 
